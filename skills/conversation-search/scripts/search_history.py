...
def decode_project_path(encoded: str) -> str:
    """Decode encoded project path (handles Windows drive letters like c--Users-...)."""
    # Windows: directory names look like "c--Users-ee01287-Documents-Projects-Krok"
    # The first segment before '--' is the drive letter
    if '--' in encoded:
...
def encode_project_path(path: str) -> str:
    """Encode project path for directory name (handles Windows drive letters)."""
